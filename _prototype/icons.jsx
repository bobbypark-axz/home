...
const Icon = {
  ...
  Settings: ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none">
      ...
      <path d="M 8 1.5 V 3 M 8 13 V 14.5 M 1.5 8 H 3 M 13 8 H 14.5 M 3.3 3.3 L 4.5 4.5 M 11.5 11.5 L 12.7 12.7 M 3.3 12.7 L 4.5 11.5 M 11.5 4.5 L 12.7 3.3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/>
    </svg>
  ),
};
